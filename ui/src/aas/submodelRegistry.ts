...
import {
  ...
  PARAMETERS_SUBMODEL,
  AIMC_SUBMODEL,
  BATCH_INFORMATION_SUBMODEL,
  BILL_OF_MATERIALS_SUBMODEL,
  REQUIREMENTS_SUBMODEL,
  BILL_OF_PROCESS_SUBMODEL,
} from './semanticIds';
...
export const SUBMODELS: Record<SubmodelKey, SubmodelDef> = {
  ...
  BatchInformation: {
    yamlKey: 'BatchInformation',
    idShort: 'BatchInformation',
    importIdShorts: ['BatchInformation'],
    semanticId: BATCH_INFORMATION_SUBMODEL,
    label: 'BatchInformation',
    description: 'Batch ID, production date, quantity, material list',
    color: '#c084fc',
    aasTypes: ['Product'],
    required: true,
  },
  BillOfMaterials: {
    yamlKey: 'BillOfMaterials',
    idShort: 'BillOfMaterials',
    importIdShorts: ['BillOfMaterials'],
    semanticId: BILL_OF_MATERIALS_SUBMODEL,
    label: 'BillOfMaterials',
    description: 'Product BOM — components, assemblies, quantities',
    color: '#22d3ee',
    aasTypes: ['Product'],
    required: true,
  },
  Requirements: {
    yamlKey: 'Requirements',
    idShort: 'Requirements',
    importIdShorts: ['Requirements'],
    semanticId: REQUIREMENTS_SUBMODEL,
    label: 'Requirements',
    description: 'Product requirements — specifications and constraints',
    color: '#f87171',
    aasTypes: ['Product'],
  },
  BillOfProcess: {
    yamlKey: 'BillOfProcess',
    idShort: 'BillOfProcess',
    importIdShorts: ['BillOfProcess'],
    semanticId: BILL_OF_PROCESS_SUBMODEL,
    label: 'BillOfProcess',
    description: 'Process steps, sequencing, and resource assignments',
    color: '#fbbf24',
    aasTypes: ['Product'],
    required: true,
  },
